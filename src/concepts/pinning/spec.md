...
```actions
pin (item: Item, scope: Scope, priority: Number, at: Date) : return (pin: Pin), refuse (message: String)
  ...
  then
    refuse "This item is already pinned in this scope."

unpin (item: Item, scope: Scope) : return (pin: Pin), refuse (message: String)
  where some pin has this item and scope
  then
    delete that pin
    return pin
  where no pin has this item and scope
  then
    refuse "There is no such pin to remove."

setPriority (item: Item, scope: Scope, priority: Number) : return (pin: Pin), refuse (message: String)
  where some pin has this item and scope
  then
  ...
  where no pin has this item and scope
  then
    refuse "There is no such pin to reprioritize."
