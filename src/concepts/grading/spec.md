...
```actions
record (learner: Learner, item: Item, evidence: Evidence, grader: Grader, score: Number, outOf: Number, feedback: String, at: Date) : return (grade: Grade), refuse (message: String)
  ...
  then
    refuse "The score must be between zero and what the grade is out of."
  where the grade of learner and item is in released
  then
    refuse "This grade has already been released."
  where the grade of learner and item is in excused
  then
    refuse "This learner has been excused from this item."

scoreCriterion (learner: Learner, item: Item, criterion: Criterion, points: Number, outOf: Number, feedback: String) : return (criterionScore: CriterionScore), refuse (message: String)
  ...
  then
    refuse "There is no grade for this learner and item."
  where the grade of learner and item is in released
  then
    refuse "This grade has already been released."
  where the grade of learner and item is in excused
  ...
  then
    refuse "The points must be between zero and what the criterion is out of."

release (learner: Learner, item: Item, at: Date) : return (grade: Grade), refuse (message: String)
  ...
  then
    refuse "There is no draft grade for this learner and item."

releaseItem (item: Item, at: Date) : return (released: set of Grades)
  then
...
retract (learner: Learner, item: Item, at: Date) : return (grade: Grade), refuse (message: String)
  where the grade of learner and item is in released
  then
  ...
  then
    refuse "There is no released grade for this learner and item."

excuse (learner: Learner, item: Item, grader: Grader, feedback: String, at: Date) : return (grade: Grade), refuse (message: String)
