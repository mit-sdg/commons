...
Administrator outbox access intentionally includes private discussion notification
bodies, even when the administrator is outside the conversation's audience. This
operational preview is an enqueue-time snapshot; it neither grants forum access
nor makes the administrator a notification recipient.
