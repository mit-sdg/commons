...
[Forum.unread.MarkAllSeen](reaction:Forum.unread.MarkAllSeen) marks every currently readable registered item in the scope
...
unregister it. These reads exclude inaccessible and trashed posts from both identities and counts.

```endpoints
Forum.unread.MarkAllSeen at /unread/markAllSeen
Forum.unread.MarkAllSeenResult at /unread/markAllSeen
Forum.unread.MarkSeen at /unread/markSeen
Forum.unread.UnreadCount at /unread/count
Forum.unread.UnreadList at /unread/list
```

[visibleUnread](view:Forum.unread.visibleUnread) Unread identities are limited to current readable posts in the requested conversation.

[theUnreadCount](former:Forum.unread.theUnreadCount) The count uses those same visible identities.

[MarkAllSeenResult](reaction:Forum.unread.MarkAllSeenResult) The settled response also succeeds when there are no visible unread posts.
