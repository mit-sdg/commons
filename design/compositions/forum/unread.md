...
[Forum.unread.UnreadList](reaction:Forum.unread.UnreadList) returns the session account's unseen registered
items in one scope. [Forum.unread.UnreadCount](reaction:Forum.unread.UnreadCount) returns their count for that
...
Formers [theUnreadOf](former:Forum.unread.theUnreadOf) support the behavior and result shapes described above.
