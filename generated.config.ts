...
export default {
  ...
  design: {
    ...
    documents: [
      ...
      new URL("./design/compositions/forum/notices.md", import.meta.url),
      ...
      new URL("./design/compositions/forum/post-controls.md", import.meta.url),
      ...
      new URL("./design/compositions/live/drafting.md", import.meta.url),
      new URL("./design/compositions/live/edits.md", import.meta.url),
