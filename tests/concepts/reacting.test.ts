...
import { ReactingConcept } from "../../src/concepts/reacting/reacting.ts";

const floors: [string, () => Promise<ReactingConcept | MongoReactingConcept>][] = [
  ["in memory", async () => new ReactingConcept()],
