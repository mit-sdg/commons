...
describe("application-owned design integration", () => {
  ...
  test("the application design records the manually audited external-role bindings", () => {
    const expectedBindings = [
      ...
      "Delegating.Item is Assigning.Assignment",
      "Delegating.Subject is Authenticating.User",
      "Delegating.Delegate is Authenticating.User",
      ...
      "Commissioning.Execution is LiveExecution",
